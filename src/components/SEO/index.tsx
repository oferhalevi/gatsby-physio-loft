...
const SEO = ({
  ...
  // https://developers.google.com/search/docs/guides/intro-structured-data You
  // can fill out the 'author', 'creator' with more data or another type (e.g.
  // 'Organization')
